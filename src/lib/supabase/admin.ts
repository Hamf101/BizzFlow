...
type AdminDocumentVersionRow = DocumentVersionRow & {
...
type AdminTaskRow = Record<string, unknown> & {
  id: string
  org_id: string
  title: string
...
type AdminTaskReminderRow = Record<string, unknown> & {
  id: string
  org_id: string
  task_id: string
...
type TaskInsert = Partial<AdminTaskRow> &
  Pick<AdminTaskRow, "id" | "org_id" | "title" | "created_by" | "updated_by">
type TaskReminderInsert = Partial<AdminTaskReminderRow> &
  Pick<
    AdminTaskReminderRow,
    "id" | "org_id" | "task_id" | "recipient_user_id" | "remind_at" | "created_by"
  >
type PublicFormLinkInsert = Partial<AdminPublicFormLinkRow> &
  Pick<AdminPublicFormLinkRow, "id" | "org_id" | "template_id" | "token">
  ...
  public: {
    Tables: {
      ...
      document_versions: DatabaseTable<
        ...
        Partial<AdminDocumentVersionRow>
      >
      ...
      submission_activity_events: DatabaseTable<
        ...
        never
      >
      tasks: DatabaseTable<AdminTaskRow, TaskInsert, Partial<AdminTaskRow>>
      task_reminders: DatabaseTable<
        AdminTaskReminderRow,
        TaskReminderInsert,
        Partial<AdminTaskReminderRow>
      >
      public_form_links: DatabaseTable<
        AdminPublicFormLinkRow,
        PublicFormLinkInsert,
        Partial<AdminPublicFormLinkRow>
      >
    }
    ...
    Functions: {
      ...
      supersede_public_submission_file: {
        Args: {
          ...
          target_public_draft_token: string
      ...
      create_pending_document_version: {
        Args: {
          ...
          target_upload_authorization_expires_at?: string | null
        }
        Returns: string
      }
