...
describe("generated document form data", () => {
  it("coerces text, checkbox, and drawing answer fields", () => {
    ...
    formData.append(getGeneratedDocumentAnswerName("text", "client_name"), "Northstar")
    formData.append(getGeneratedDocumentAnswerName("boolean", "approved"), "false")
    formData.append(getGeneratedDocumentAnswerName("boolean", "approved"), "true")
    formData.append(
