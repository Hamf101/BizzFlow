...
export const TABLE_CHECKS = [
  ...
  },
  {
    ...
    select:
      "id,org_id,document_id,version_number,status,upload_authorization_expires_at,created_at,updated_at",
  },
  {
...
export const SERVICE_ROLE_RPC_CHECKS = [
  ...
  {
    name: "register_document_version_upload_authorization",
    args: {
      target_org_id: null,
  ...
  {
    name: "reconcile_document_upload_authorization_barriers",
    args: {
