...
- Current state: Sprint 4 document storage implementation. The Next.js App Router dashboard includes tenant documents, folders, signed upload/download routes, and document detail pages.
