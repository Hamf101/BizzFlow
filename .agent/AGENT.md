...
- Users can replace documents while keeping version history.
...
- User can fill a form offline and sync it later.
...
- [ ] Supabase project configured with real project values.
